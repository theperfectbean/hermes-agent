...
def _run_single_child(
    ...
    **_kwargs,
    ...
    try:
        ...
        # A child safety gate may deliberately return a safe explanatory
        # response while marking the claimed operational outcome unverified or
        # blocked. Preserve that distinction for the parent: never flatten it
        # back to a successful delegated completion merely because text exists.
        if operational_status in {"unverified", "blocked"}:
        ...
        entry: Dict[str, Any] = {
            ...
            "operational_status": (
                operational_status if operational_status in {"verified", "unverified", "blocked"}
                else None
            ),
