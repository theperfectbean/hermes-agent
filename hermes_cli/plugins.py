...
VALID_HOOKS: Set[str] = {
    ...
    "pre_verify",
    # Provider-neutral finalization policy. A local plugin can arm a turn
    # before streaming and return a bounded terminal decision without core
    # code knowing which provider or environment it protects.
    "pre_finalize",
    "pre_api_request",
    "post_api_request",
    "api_request_error",
